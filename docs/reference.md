...
The public API lives at the module root (`github.com/go-ruby-rails/rails`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `rails`, while the surface follows
...
- **[pkg.go.dev/github.com/go-ruby-rails/rails](https://pkg.go.dev/github.com/go-ruby-rails/rails)**

The module's [README](https://github.com/go-ruby-rails/rails#readme) carries worked
