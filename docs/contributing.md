...
Contributions are welcome. `go-ruby-rails/rails` is built to a small set of
...
The library is in [`github.com/go-ruby-rails/rails`](https://github.com/go-ruby-rails/rails).
This documentation site is in [`github.com/go-ruby-rails/docs`](https://github.com/go-ruby-rails/docs).
