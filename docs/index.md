# go-ruby-rails documentation

**Pure-Go, MRI-4.0.5-faithful Ruby rails (no cgo)**

`go-ruby-rails/rails` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `rails`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-rails/rails`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `rails`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`rails`](https://github.com/go-ruby-rails/rails) | the library — Ruby's `rails` in pure Go |
| [`docs`](https://github.com/go-ruby-rails/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-rails.github.io`](https://github.com/go-ruby-rails/go-ruby-rails.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-rails/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-rails/rails](https://github.com/go-ruby-rails/rails).
